  ...
  return (
    <div className="container my-5 terms">
      ...
      <div id="AGREEMENT TO TERMS">
        <h3 className="headings">1. AGREEMENT TO TERMS</h3>
        <p>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (â€œyouâ€) and
          FaceFind ("Company," â€œwe," â€œus," or â€œourâ€), concerning your
          access to and use of the{" "}
          <a href=" https://facefind.ai">https://facefind.ai</a> website as well
          as any other media form, media channel, mobile website or mobile
          application related, linked, or otherwise connected thereto
          (collectively, the â€œSiteâ€). You agree that by accessing the Site,
          ...
          updating the â€œLast updatedâ€ date of these Terms of Use, and you
      ...
      <div id="INTELLECTUAL PROPERTY RIGHTS">
        <h3 className="headings">2.Â INTELLECTUAL PROPERTY RIGHTS</h3>
        <p>
          ...
          (collectively, the â€œContentâ€) and the trademarks, service marks,
          and logos contained therein (the â€œMarksâ€) are owned or controlled
          ...
          on the Site â€œAS ISâ€ for your information and personal use only.
      ...
      <div id="USER REPRESENTATIONS">
        <h3 className="headings">3.Â USER REPRESENTATIONS</h3>
        <p>
          By using the Site, you represent and warrant that:Â (1) all
          registration information you submit will be true, accurate, current,
          and complete; (2) you will maintain the accuracy of such information
          and promptly update such registration information as necessary;Â (3)
          you have the legal capacity and you agree to comply with these Terms
          of Use;Â (4) you are not a minor in the jurisdiction in which you
      ...
      <div id="USER REGISTRATION">
        <h3 className="headings">4.Â USER REGISTRATION</h3>
        <p>
          <b>Â Â Â</b> <br />
      ...
      <div id="PROHIBITED ACTIVITIES">
        <h3 className="headings">5.Â PROHIBITED ACTIVITIES</h3>
        <p>
        ...
        <ul>
          ...
          <li>
            Copy or adapt the Siteâ€™s software, including but not limited to
      ...
      <div id="USER GENERATED CONTRIBUTIONS">
        <h3 className="headings">6.Â USER GENERATED CONTRIBUTIONS</h3>
        <p>
      ...
      <div id="CONTRIBUTION LICENSE">
        <h3 className="headings">7.Â CONTRIBUTION LICENSE</h3>
        <p>
      ...
      <div id="SUBMISSIONS">
        <h3 className="headings">8.Â SUBMISSIONS</h3>
      ...
      <div id="THIRD-PARTY WEBSITE AND CONTENT">
        <h3 className="headings">9.Â THIRD-PARTY WEBSITE AND CONTENT</h3>
        <p>
      ...
      <div id="ADVERTISERS">
        <h3 className="headings">10.Â ADVERTISERS</h3>
        <p>
      ...
      <div id="SITE MANAGEMENT">
        <h3 className="headings">11.Â SITE MANAGEMENT</h3>
        <p>
      ...
      <div id="PRIVACY POLICY">
        <h3 className="headings">12.Â PRIVACY POLICY</h3>
        <p>
          We care about data privacy and security.Â Please review our Privacy
          Policy:Â{" "}
          <a href="https://facefind.ai/privacy-policy.html">
            https://facefind.ai/privacy-policy.html
          </a>
          .Â By using the Site, you agree to be bound by our Privacy Policy,
      ...
      <div id="TERM AND TERMINATION">
        <h3 className="headings">13.Â TERM AND TERMINATION</h3>
        <p>
          ...
          PARTICIPATION IN THE SITE OR DELETE YOUR ACCOUNT ANDÂ ANY CONTENT OR
      ...
      <div id="MODIFICATIONS AND INTERRUPTIONS">
        <h3 className="headings">14.Â MODIFICATIONS AND INTERRUPTIONS</h3>
        <p>
      ...
      <div id="DISPUTE RESOLUTION">
        ...
        <p>
          ...
          Transaction Act (UCITA) are excluded from these Terms of Use.Â In no
      ...
      <div id="CORRECTIONS">
        <h3 className="headings">17.Â CORRECTIONS</h3>
        <p>
      ...
      <div id="DISCLAIMER">
        <h3 className="headings">18.Â DISCLAIMER</h3>
        <p>
      ...
      <div id="LIMITATIONS OF LIABILITY">
        <h3 className="headings">19.Â LIMITATIONS OF LIABILITY</h3>
        <p>
          ...
          PAID, IF ANY, BY YOU TO USÂ DURING THE ONE (1) MONTH PERIOD PRIOR TO
      ...
      <div id="INDEMNIFICATION">
        <h3 className="headings">20.Â INDEMNIFICATION</h3>
        <p>
      ...
      <div id="USER DATA">
        <h3 className="headings">21.Â USER DATA</h3>
        <p>
      ...
      <div id="ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES">
        <h3 className="headings">
          22.Â ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
        </h3>
        <p>
      ...
      <div id="CALIFORNIA USERS AND RESIDENTS">
        <h3 className="headings">23.Â CALIFORNIA USERS AND RESIDENTS</h3>
        <p>
      ...
      <div id="MISCELLANEOUS">
        <h3 className="headings">24.Â MISCELLANEOUS</h3>
        <p>
      ...
      <div id="CONTACT US">
        ...
        <strong>FaceFind</strong>
        <hr style={{width: '150px',margin: '5px 0px 5px 0px'}} />
        <a href="mailto:info@facefind.ai">info@facefind.ai</a>
      </div>
    </div>
  );
};
