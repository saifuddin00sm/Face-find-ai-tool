...
export const PrivacyPolicy = () => {
  return (
    <div className="container my-5 privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to FaceFind, NYC.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to FaceFind, accessible from{" "}
            <a
              href="facefind.ai"
      ...
      <ul>
        <li>
          By email: <a href="mailto:privacy@facefind.ai">privacy@facefind.ai</a>
        </li>
      </ul>
    </div>
  );
